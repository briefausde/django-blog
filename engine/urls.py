...
urlpatterns = [
    ...
    url(r'^notifications/author/subscribe/$', views.SubscribeOnUserNotificationsView.as_view(), name='subscribe_on_author'),
    url(r'^notifications/author/unsubscribe/$', views.UnSubscribeOnUserNotificationsView.as_view(), name='unsubscribe_on_author'),
